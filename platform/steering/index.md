...
description: Submit bounded steering or cancellation input to a WEDNESDAY turn while the turn is still accepting input.
permalink: /platform/steering/
markdown_url: /platform/steering.md
---
